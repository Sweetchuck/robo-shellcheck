...
namespace Sweetchuck\Robo\Shellcheck\Tests\Helper\Dummy;
...
class DummyTaskBuilder implements BuilderAwareInterface, ContainerAwareInterface
{
    ...
    use ShellcheckTaskLoader {
        taskShellcheckVersion as public;
        taskShellcheckListOptional as public;
        taskShellcheckCheckFiles as public;
        taskShellcheckCheckInput as public;
    }
